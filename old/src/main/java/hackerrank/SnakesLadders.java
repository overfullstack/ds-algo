...
public class SnakesLadders {
  public static void main(String[] args) {
    ...
    for (var i = 0; i < testCases; i++) {
      ...
      for (var l = 0; l < ladders; l++) snakeOrLad.put(scn.nextInt(), scn.nextInt());
      var snakes = scn.nextInt();
      for (var s = 0; s < snakes; s++) snakeOrLad.put(scn.nextInt(), scn.nextInt());
      ...
      while (!boardQueue.isEmpty()) {
        ...
        for (var v = 1; v <= 6 && square.vertex + v <= 100; v++) {
          ...
          var connectedVertex =
              (referencedVertex != null && referencedVertex <= 100)
                  ? referencedVertex
                  : square.vertex + v;
