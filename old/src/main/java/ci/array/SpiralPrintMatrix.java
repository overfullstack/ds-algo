...
public class SpiralPrintMatrix {
	...
	private static void printSpiral(int[][] matrix, int rows, int cols, int start) {
		...
		// right to left, minimum 2 rows and 2 cols required, two rows because if only one row, it would
		// have been
		...
		// bottom to top, atleast 3 rows and 2 cols, as if only 2 rows, it would hv already been
		// covered.
