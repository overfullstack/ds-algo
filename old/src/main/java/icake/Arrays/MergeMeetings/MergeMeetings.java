...
public class MergeMeetings {
  ...
  private static Meeting[] mergeMeetings(Meeting[] meetings) {
    ...
    for (var i = 1; i < meetings.length; i++) {
      ...
      if (lastMergedMeeting.endTime
          >= curMeeting.startTime) { // Overlapped meeting, Swallow or merge curMeeting into
        // lastMergedMeeting
        ...
        // This is independent of previous last merged meeting, but if it's merged with next
        // meetings,
