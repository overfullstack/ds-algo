...
// This is common code for both threads. You could instead have two different thread classes for
// even and odd.
class MyThread extends Thread {
	private final boolean
			isEven; // Switch-1, this is constant for a Thread, used to initialize first number to 2 or 1,
	// then increment +=2
...
class SharedPrinter {
	private boolean printOddNow =
			true; // Switch-2, this is common switch and gets switched by threads
