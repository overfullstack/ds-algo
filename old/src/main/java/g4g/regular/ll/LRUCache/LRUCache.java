package g4g.regular.ll.LRUCache;

import g4g.ds.DLLNode;
import g4g.ds.Utils;
...
public class LRUCache {
  ...
  private void referPage(int pageNo) {
    ...
    // So DLL is used. DLL instead of SLL, coz in SLL, you cannot swap node with node's own
    // reference in O(1)
    // DLL is used over SLL because you can remove or move a node with it's own pointer, unlike SLL
    // where you need previous pointer
