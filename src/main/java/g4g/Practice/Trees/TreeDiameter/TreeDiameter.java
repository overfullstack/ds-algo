package g4g.Practice.Trees.TreeDiameter;
...
public class TreeDiameter {
    ...
    private static int diameter(TreeNode root, Height height) {
        ...
        var leftHeight = new Height(1); // 1 for including current node. These nodes go as refs in recursion and get updated
        ...
        var diameterPassingViaCurrentNode = leftHeight.height + rightHeight.height + 1; // here +1 is for root
