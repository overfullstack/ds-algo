package g4g.Regular.Trees.VerticalSum;
...
import static g4g.DsAndUtils.Utils.printDLL;
...
public class VerticalSum {
    ...
    private static void verticalSumWithMap(TreeNode root, Map<Integer, Integer> map, int horizontalDistance) {
        if (root == null) {
            return;
        }
