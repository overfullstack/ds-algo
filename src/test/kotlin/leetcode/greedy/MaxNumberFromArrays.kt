...
tailrec operator fun List<Int>.compareTo(other: List<Int>): Int =
    when {
...
private tailrec fun mergeMaxNums(
    ...
    when {
        ...
        num1Digits >= num2Digits -> mergeMaxNums(num1Digits.drop(1), num2Digits, mergedDigits + num1Digits.first())
