...
fun wordSearch(grid: Array<CharArray>, word: String): Boolean {
  ...
  return wordStartIndices.any { (r, c) ->
    ...
    directions
      ...
      .any { (r, c) ->
        wordSearchInternal(grid, word, r, c, 2, visited.apply { this[r][c] = true }).also {
          visited[r][c] = false
        }
      }
  }
...
private fun wordSearchInternal(
  ...
  if (wordIndex > word.lastIndex) {
    ...
    directions
      ...
      .any { (r, c) ->
        wordSearchInternal(grid, word, r, c, wordIndex + 1, visited.apply { this[r][c] = true })
          .also { visited[r][c] = false }
      }
  }
