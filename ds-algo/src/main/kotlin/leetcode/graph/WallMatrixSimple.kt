 ...
 * 
 * Similar to LeetCode 1254 - Number of Closed Islands
 * Given a matrix where 1 represents land and 0 represents water,
 * count the number of water regions completely surrounded by land.
 */
...
private fun floodFillWater(grid: Array<IntArray>, row: Int, col: Int) {
    ...
    directions.forEach { (dr, dc) ->
        floodFillWater(grid, row + dr, col + dc)
    }
}
