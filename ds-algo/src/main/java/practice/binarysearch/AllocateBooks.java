...
public class AllocateBooks {
  ...
  static void main() {
    IO.println(findPages(new ArrayList<>(List.of(12, 34, 67, 90)), 4, 2)); // 113
    IO.println(findPages(new ArrayList<>(List.of(25, 46, 28, 49, 24)), 5, 4)); // 71
    IO.println(findPages(new ArrayList<>(List.of(2, 8, 8, 4, 5)), 5, 6)); // -1
    IO.println(findPages(new ArrayList<>(List.of(1, 17, 14, 9, 15, 9, 14)), 7, 7)); // 17
  }
}
