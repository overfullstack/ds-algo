...
class ChunkingTest :
  StringSpec({
    "Chunking Test" {
      ...
      val ctx2 =
        mutableMapOf(
          Id(1) to ContextRecord(250, 1, null),
          Id(2) to ContextRecord(250, 1, null),
          Id(3) to ContextRecord(250, 1, null),
          Id(4) to ContextRecord(250, 2, null),
        )
      forAll(row(ctx1, result1), row(listOf(250, 210).toContext(), 1), row(ctx2, 2)) {
        context,
        result ->
